...
public class MainActivity extends Activity implements ApplicationConsts,OnItemLongClickListener {

	public static final int UPDATE_PROGRESS_OK =0x1;
	...
	private void initViews() {
		...
		visualizer = (VisualizerView) childViews[1]
				.findViewById(R.id.activity_player_visualizer);
		// 初始化消息持有者
							...
							builder.setPositiveButton(
									...
									new DialogInterface.OnClickListener() {
										...
										public void onClick(
											...
											// stub
											MusicDao dao=new MusicDao(app);
											dao.delete(musics.get(position).getId());
